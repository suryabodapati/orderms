...
public class OrderController {
	...
	public String placeOrder(@PathVariable String buyerId,@RequestBody OrderDTO orderdto) {
		...
		if(p!=null) {
			return "Order is placed with orderId:"+p.getOrderId();
		}
	...
	public List<OrderDTO> getOrderDetailsBasedonBuyer(@PathVariable String buyerId) throws InfyUserException {
	...
	public OrderDTO getOrderDetails(@PathVariable String orderId) throws InfyUserException {

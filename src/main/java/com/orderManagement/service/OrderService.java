...
public class OrderService {
	...
	public OrderDTO getOrderDetails(String orderId) throws InfyUserException {
		
		Order order=orderRepo.findById(orderId).get();
		
		if(order==null)
			throw new InfyUserException("No order details are present for the given orderId");
	...
	public List<OrderDTO> getOrderDetailsBasedonBuyer(String buyerId) throws InfyUserException {
		
		List<Order> order=orderRepo.findByBuyerId(buyerId);
		
		if(order==null)
			throw new InfyUserException("No order details are present for the given buyerId");
